...
<div class="mini">
  <ul>
  <li> <strong>[Aug 2026]</strong> 🎉I have been awarded the National Natural Science Foundation of China!</li>
  <li> <strong>[Aug 2026]</strong> 🎉One paper about 3D self-supervised Learning is accepted by <strong>TITS (IF: 8.9)</strong>!</li>
  <li> <strong>[May 2026]</strong> 🎉I have been awarded the Fujian Provincial Natural Science Foundation of China!</li>
...
<font face="helvetica, ariel, &#39;sans serif&#39;">
        <table cellspacing="0" cellpadding="0" class="noBorder">
           <tbody>
            <tr>
                    <td class="noBorder" width="30%" align="center">
                        <img width="300" src="../images/BeyondSparse.png" border="0">
                    </td>
                    <td>
                      <h3> BeyondSparse: Facilitating Mamba to Enhance Cross-Domain 3D Semantic Segmentation in Adverse Weather </h3>
                      <strong>Yao Wu</strong>, Mingwei Xing, Yachao Zhang, Fangyong Wang, Xiaopei Zhang, Yanyun Qu. 
                      <br>
                      <em>Annual AAAI Conference on Artificial Intelligence (<strong>AAAI 2026</strong>, CCF-A, <font color=red>Oral presentation</font>) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3 style="margin: 0;">PLATO-TTA: Prototype-Guided Pseudo-Labeling and Adaptive Tuning for Multi-Modal Test-Time Adaptation of 3D Segmentation </h3>
                      Jianxiang Xie, <strong>Yao Wu</strong>1️⃣, Yachao Zhang, Xiaopei Zhang, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>ACM International Conference on Multimedia (<strong>ACM MM 2025</strong>, CCF-A) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3>Fusion-then-Distillation: Toward Cross-modal Positive Distillation for Domain Adaptive 3D Semantic Segmentation </h3>
                      <strong>Yao Wu</strong>, Mingwei Xing, Yachao Zhang, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>IEEE Transactions on Circuits and Systems for Video Technology (<strong>TCSVT 2025</strong>, JCR-Q1, CCF-B) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3>Omni-Query Active Learning for Source-Free Domain Adaptive Cross-Modality 3D Semantic Segmentation </h3>
                      Jianxiang Xie, <strong>Yao Wu</strong>1️⃣, Yachao Zhang, Zhongchao Shi, Jianping Fan, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>Association for the Advancement of Artificial Intelligence (<strong>AAAI 2025</strong>, CCF-A) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3>UniDSeg: Unified Cross-Domain 3D Semantic Segmentation via Visual Foundation Models Prior </h3>
                      <strong>Yao Wu</strong>, Mingwei Xing, Yachao Zhang, Xiaotong Luo, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>Annual Conference on Neural Information Processing Systems (<strong>NeurIPS 2024</strong>, CCF-A) </em>
                      <br>
            ...
            <tr>
                    <td class="noBorder" width="30%" align="center">
                        <img width="300" src="../images/RE-GZSL.jpg" border="0">
                    </td>
                    <td>
                      <h3>RE-GZSL: Relation Extrapolation for Generalized Zero-Shot Learning </h3>
                      <strong>Yao Wu</strong>, Xia Kong, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>IEEE Transactions on Circuits and Systems for Video Technology (<strong>TCSVT 2024</strong>, JCR-Q1, CCF-B) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3>CLIP2UDA: Making Frozen CLIP Reward Unsupervised Domain Adaptation in 3D Semantic Segmentation </h3>
                      <strong>Yao Wu</strong>, Mingwei Xing, Yachao Zhang, Yuan Xie, Yanyun Qu. 
                      <br>
                      <em>ACM International Conference on Multimedia (<strong>ACM MM 2024</strong>, CCF-A) </em>
                      <br>
            ...
            <tr>
                    ...
                    <td>
                      <h3>CLIP-FSAC: Boosting CLIP for Few-Shot Anomaly Classification with Synthetic Anomalies </h3>
                      Zuo Zuo, <strong>Yao Wu</strong>1️⃣, Baoqiang Li, Jiahao Dong, You Zhou, Lei Zhou, Yanyun Qu, Zongze Wu. 
                      <br>
                      <em>International Joint Conference on Artificial Intelligence (<strong>IJCAI 2024</strong>, CCF-A) </em>
                      <br>
            ...
            <tr>
                    <td class="noBorder" width="30%" align="center">
                        <img width="180" src="../images/PPL.png" border="0">
                    </td>
                    <td>
                      <h3>Perturbed Progressive Learning for Semisupervised Defect Segmentation </h3>
                      <strong>Yao Wu</strong>, Mingwei Xing, Yachao Zhang, Yuan Xie, Zongze Wu, Yanyun Qu. 
                      <br>
                      <em>IEEE Transactions on Neural Networks and Learning Systems (<strong>TNNLS 2023</strong>, JCR-Q1, CCF-B) </em>
                      <br>
